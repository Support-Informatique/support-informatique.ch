...
const Hero: React.FC = () => {
  return (
    <div>
      ...
      />
      <div className='bg-mountains md:drop-shadow-hero-mac bg-top bg-cover rounded-[20px] absolute w-full md:w-9/12 h-3/4 top-0 md:left-1/2 transform md:-translate-x-1/2 md:translate-y-20'>
        ...
        <div className='flex flex-col justify-around items-center h-full gap-y-40 overflow-hidden pb-20 md:pb-0'>
        ...
        <img
          ...
          className='block md:hidden absolute -bottom-1 w-full -z-10'
        />
      </div>
    </div>
  )
